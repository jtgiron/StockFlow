...
CREATE INDEX IF NOT EXISTS idx_mp_pending_orders_external_ref ON mp_pending_orders (
    external_reference
);
CREATE INDEX IF NOT EXISTS idx_mp_pending_orders_status ON mp_pending_orders (
    status
);
CREATE INDEX IF NOT EXISTS idx_mp_pending_orders_merchant_id ON mp_pending_orders (
    merchant_id
);
